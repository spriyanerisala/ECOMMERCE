...
<Routes>
  ...
  <Route path='/products/:category' element={<PageWrapper><ProductCategory /></PageWrapper>} />
  <Route path='/products/:category/:id' element={<PageWrapper><ProductDetails /></PageWrapper>} />
